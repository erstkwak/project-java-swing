...
import controller.I_DeaController;

public class DeaCreDialog extends JDialog {
	...
	I_DeaController deaController;
	
	public DeaCreDialog(String title) {
		setTitle(title);
		setResizable(false);
		
		lblName    = new JLabel("사망자 이름 (필수)"    ); tfName    = new JTextField(20);
		lblGender  = new JLabel("사망자 성별"           ); tfGender  = new JTextField(20);
		lblAge     = new JLabel("사망자 나이 (숫자)"    ); tfAge     = new JTextField(20);
		lblPhone   = new JLabel("사망자 전화번호 (필수 & 중복 X)"); tfPhone   = new JTextField(20);
		lblSido    = new JLabel("사망자 시도"           ); tfSido    = new JTextField(20);
		lblGugun   = new JLabel("사망자 구군"           ); tfGugun   = new JTextField(20);
		lblAddress = new JLabel("사망자 상세주소"       ); tfAddress = new JTextField(20);		
	...
	public void initFrame() {
		...
		getContentPane().add(btnChoice, BorderLayout.SOUTH);
	...
	public void updateData() {
		...
		btnChoice.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				deaController.updateDeaData(deaVO);
	...
	public void createData() {	
		...
		btnChoice.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				deaController.createDeaData(deaVO);
