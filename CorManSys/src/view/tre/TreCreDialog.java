...
import controller.I_TreController;
import controller.TreController;

public class TreCreDialog extends JDialog {
	...
	I_TreController treController;
	
	public TreCreDialog(String title) {
		setTitle(title);
		setResizable(false);
		
		lblName    = new JLabel("피검사자 이름 (필수)"    ); tfName    = new JTextField(20);
		lblGender  = new JLabel("피검사자 성별"           ); tfGender  = new JTextField(20);
		lblAge     = new JLabel("피검사자 나이 (숫자)"    ); tfAge     = new JTextField(20);
		lblPhone   = new JLabel("피검사자 전화번호 (필수 & 중복 X)"); tfPhone   = new JTextField(20);
	...
	public void updateData() {
		...
		btnChoice.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				treController.updateTreData(treVO);
	...
	public void createData() {	
		...
		btnChoice.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				treController.createTreData(treVO);
